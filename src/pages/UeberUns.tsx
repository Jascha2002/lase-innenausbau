      ...
      <section className="py-20">
        <div className="container">
          ...
          >
            ...
            <p className="mt-1 text-accent font-medium">Inhaber & Handwerksmeister</p>
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Mit langjähriger Erfahrung im Innenausbau habe ich LA.SE Innenausbau gegründet, 
              um meinen Kunden in Gera und Umgebung erstklassige Handwerksarbeit zu bieten. 
              Von der ersten Beratung bis zum letzten Handgriff stehe ich persönlich für Qualität 
              und Zuverlässigkeit. Mein Anspruch: Jedes Projekt wird so behandelt, als wäre es mein eigenes Zuhause.
            </p>
          </motion.div>
